...
public class Excel_Post_Adapter extends BaseAdapter {
    private Context context ;
    private List<Excel_Post_Data> list;

    public Excel_Post_Adapter(Context context, List<Excel_Post_Data> list){
